...
# transform the image to the fit on the map
...
# render onto a map (top one if you want to do it without opening the resulting image, bottom if not...):
...
#nik2img.py weather.xml weathermap.png --srs 900913 --dimensions 750 1000  --projected-extent -1335833.89 6106854.83 556597.45 8625823.20 -w pgw #> /dev/null 2>&1